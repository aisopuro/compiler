...
public class Scanner {
	...
	static {
		...
		for (int i = 97; i <= 113; ++i) start.set(i, 1);
		for (int i = 115; i <= 122; ++i) start.set(i, 1);
		...
		literals.put("fi", new Integer(12));
		literals.put("while", new Integer(13));
		literals.put("print", new Integer(14));
		literals.put("true", new Integer(18));
		literals.put("false", new Integer(19));
		literals.put("int", new Integer(21));
